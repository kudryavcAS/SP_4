...
namespace {
struct qt_meta_tag_ZN4DiffE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4DiffE = QtMocHelpers::stringData(
    "Diff"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4DiffE[] = {
...
Q_CONSTINIT const QMetaObject Diff::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4DiffE.offsetsAndSizes,
    qt_meta_data_ZN4DiffE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4DiffE_t,
        // Q_OBJECT / Q_GADGET
...
void *Diff::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4DiffE.stringdata0))
